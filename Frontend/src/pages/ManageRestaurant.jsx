            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="border-t border-gray-100 pt-8">
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full md:w-auto bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-8 py-3 rounded-xl font-semibold transition-all disabled:opacity-50 shadow-lg shadow-indigo-500/30 hover:shadow-xl hover:shadow-indigo-500/40"
                >
